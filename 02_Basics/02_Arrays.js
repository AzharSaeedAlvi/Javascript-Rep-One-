...
// // depth but in this case we will use infinity   // Learn how to use flat without using infinity.  
// console.log(real_another_array); // Returns in the form of single array 


// console.log(Array.isArray("Azhar")) // Will return false
...
console.log(Array.of(A,B,C))  // Combines and creates a new array || Had we used an array then it will store array at different index place. 
